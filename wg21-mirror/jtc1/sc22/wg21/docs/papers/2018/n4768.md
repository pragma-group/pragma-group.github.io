...
```
Document:       ISO/IEC JTC1/SC22/WG21 N4768

Date:           2017-08-14

Period Covered: August 2017 - August 2018
...
JTC1.22.14882 - Programming Language C++ - This project was delivered by the publishing of ISO/IEC 14882:1998, :2003, :2011, :2014, and :2017.
...
JTC1.22.19570:2018: C++ Extensions for Parallelism, 2nd edition
...
JTC1.22.21425: C++ Extensions for Ranges

JTC1.22.21544: C++ Extensions for Modules
...
JTC1.22.14882 - Work is now underway on the next revision, which is targeted for publication in 2020.

JTC1.22.xxxxx: C++ Extensions for Reflection - New work item ballot is in progress. Tentatively targeted for publication in 2019.
...
3) standardization participation, so that meeting attendance is regularly approximately 140 experts organized into 10-12 active subgroups -- this includes domain-specific subgroups (e.g., transactional memory, graphics, gaming) that were established since 2012 and have drawn domain experts who did not previously participate in C++ standardization; and

4) faster and more predictable standardization output, with regular releases of the standard every three years along with many concurrent Technical Specifications (13 completed and published from 2014 to 2018).

### 2.2. ACHIEVEMENTS

Achievements in the past year include the following.

JTC1.22.14882:2017 - Programming Language C++ - International Standard

JTC1.22.19570: C++ Extensions for Parallelism, 2nd edition

JTC1.22.21544: C++ Extensions for Modules

Two Technical Specifications are expected  to be started in the coming year (concurrency 2nd edition, reflection). Much of the content in these and the published TSes are likely candidates for inclusion in the next two planned revisions of IS 14882 in 2020 and 2023.
...
WG21 is working on the next revision of JTC.22.14882 (IS C++) and progressing several other TS projects as noted in 1.2.2. Several are expected to progress to their next ballot stages, and in some cases to publication, in the next 12 months.
...
WG21 intends to continue working on new language and/or library extensions with a view to publishing multiple TSes and then another new JTC1.22.14882 IS in 2020.
